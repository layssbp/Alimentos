        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li @if($current == "tipos") class = "active" @endif>
                    <a href="#"  data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">Categorias</a>
                    <ul class="collapse list-unstyled" id="">
                        <li>
                            <a href="/tipos/nova">Nova</a>
                        </li>
                        <li>
                            <a href="/tipos/">Listar</a>
                        </li>
                        <li>
                            <a href="/tipos/restaurar">Restaurar</a>
                        </li>
                    </ul>
                </li>
